...
Convolutional networks have been around for a long time, but the current incarnation of these networks can be traced back to the seminal work of LeCun et al.\ \cite{lecun1998gradient}. % TODO: Don't make schmidhuber angry
...
They are commonly used in facial identification pipelines, as well as in motion capture and expression recognition. % TODO: citations for all this shit
...
% TODO citations
Additionally, these classification networks usually have fully connected (or dense) layers towards the end.
This ensures that the receptive field of the network covers the entire image, which is practical for many applications where a scalar or fixed size prediction is required. % TODO: citations?
...
A lot of work has been done on using curvature information for detection \cite{monroy2011beyond}, classification \cite{fischer2014image}, and species identification \cite{kumar2012leafsnap}. % Explain more?
