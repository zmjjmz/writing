...
While we default to measuring 2 through 8 percent of the trailing edge (taking even numbers), we can see that increasing this further yields diminishing returns. % TODO: maybe. I think so.
