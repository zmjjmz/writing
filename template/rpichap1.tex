...
% TODO: Put in examples of failures due to trailing edges not being clear, and the figure from blackmer showing the same whale w/entirely different textures
